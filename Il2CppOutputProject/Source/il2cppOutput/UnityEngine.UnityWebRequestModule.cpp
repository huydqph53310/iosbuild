...
IL_000d_1:
			...
			}
			{
				...
				NullCheck(L_12);
				VirtualActionInvoker1< uint8_t >::Invoke(33, L_12, (uint8_t)((int32_t)32));
				goto IL_0057_1;
			}
...
IL_0029_1:
			...
			}
			{
				...
				NullCheck(L_22);
				VirtualActionInvoker1< uint8_t >::Invoke(33, L_22, L_26);
				goto IL_0057_1;
			}
...
IL_004e_1:
			{
				...
				NullCheck(L_27);
				VirtualActionInvoker1< uint8_t >::Invoke(33, L_27, L_31);
			}
...
IL_005b_1:
			...
			}
			{
				...
				L_37 = VirtualFuncInvoker0< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(37, L_36);
				V_2 = L_37;
				goto IL_0074;
			}
		}
...
{
	{
		...
		VirtualActionInvoker1< int32_t >::Invoke(11, __this, L_1);
		return;
	}
}
...
FINALLY_0043:
		...
		try
		{
			{
				intptr_t L_1;
				L_1 = BindingsMarshaller_ConvertToNative_m4520B52F497C3D16FB3E6ADB12DE939EF6494D56_inline(__this, NULL);
				intptr_t L_2 = L_1;
				if (L_2)
				{
					G_B2_0 = L_2;
...
IL_000f_1:
			{
				String_t* L_3 = ___0_newContentType;
				bool L_4;
				L_4 = StringMarshaller_TryMarshalEmptyOrNullString_m615203C511071D59295D889AB136575DFFEA90A6_inline(L_3, (&V_2), NULL);
				if (L_4)
				{
			...
			{
				String_t* L_5 = ___0_newContentType;
				ReadOnlySpan_1_t59614EA6E51A945A32B02AB17FBCBDF9A5C419C1 L_6;
				L_6 = MemoryExtensions_AsSpan_m0EB07912D71097A8B05F586158966837F5C3DB38_inline(L_5, NULL);
				V_0 = L_6;
				Il2CppChar* L_7;
