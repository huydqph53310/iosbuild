...
#import "UnityFramework/UnityCoreInterface.h"
#endif
...
void * UnityAdsShowListenerCreate(void *showFailureCallback, void *showStartCallback, void *showClickCallback, void *showCompleteCallback) {
    return NULL;
}
